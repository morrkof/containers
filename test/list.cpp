...
void test_list()
{
	...
	std::cout << "Create this:  " << std::endl << v_erase << ft_erase;
	v_erase.erase(v_erase.begin());
	ft_erase.erase(ft_erase.begin());
	std::cout << "Erase first:  " << std::endl << v_erase << ft_erase;
	v_erase.erase(--v_erase.end());
	ft_erase.erase(--ft_erase.end());
	std::cout << "Erase last:  " << std::endl << v_erase << ft_erase;
	}
	...
	<<  "1st - " << ft_sw1 << "2nd - " << ft_sw2 << std::endl ;
	std::swap(std_sw1, std_sw2);
	ft::swap(ft_sw1, ft_sw2);
	std::cout << "after swap (non-member):" << std::endl <<  "1st - " << std_sw1 << "2nd - " << std_sw2
	<<  "1st - " << ft_sw1 << "2nd - " << ft_sw2 << std::endl ;
